...
public class USBItemFragment extends BaseFragment {
    ...
    private OMediaItemRecyclerViewAdapter OMediaItemRecyclerViewAdapter;
    private RecyclerView mRecyclerView;
    private TextView emptyView;
    private VideoList videoList = Cabinet.getPlayManager().getLocalUSBMediaVideos();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        OMediaItemRecyclerViewAdapter = new OMediaItemRecyclerViewAdapter(videoList.toOMediaList());
        mRecyclerView.setAdapter(OMediaItemRecyclerViewAdapter);
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        OMediaItemRecyclerViewAdapter.setOnItemClickListener(new OMediaItemRecyclerViewAdapter.OnItemClickListener() {
            @Override
    ...
    private void checkIfEmpty() {
        if (OMediaItemRecyclerViewAdapter.getItemCount() == 0) {
    ...
    private void updateData(int dataId) {
        videoList = Cabinet.getPlayManager().getLocalUSBMediaVideos();
        OMediaItemRecyclerViewAdapter.setData(videoList.toOMediaList());
        OMediaItemRecyclerViewAdapter.notifyDataSetChanged();
        checkIfEmpty();
    }
}